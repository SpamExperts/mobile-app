...
function checkLayout(mailBtn, checkMail) {
    ...
    browser.wait(EC.visibilityOf(mailBtn.mabWhiteAndRelease), 5000)
        .then(function () {
            expect(mailBtn.mabWhiteAndRelease.isPresent())
                .toBeTruthy();
        });
    browser.wait(EC.visibilityOf(mailBtn.mabBlackAndRemove), 5000)
        .then(function () {
            expect(mailBtn.mabBlackAndRemove.isPresent())
                .toBeTruthy();
        });
    ...
    browser.wait(EC.visibilityOf(checkMail.mabWhiteAndRelease), 5000)
        .then(function () {
            expect(checkMail.mabWhiteAndRelease.isPresent())
                .toBeTruthy();
        });
    browser.wait(EC.visibilityOf(checkMail.mabBlackAndRemove), 5000)
        .then(function () {
            expect(checkMail.mabBlackAndRemove.isPresent())
                .toBeTruthy();
        });
    browser.actions()
        .click()
