var CategoryPanel = function(){
	...
	this.iHeader = element(by.cssContainingText('.ng-binding.higher-text','Incoming spam messages'));
	...
	this.oHeader = element(by.cssContainingText('.ng-binding.higher-text','Outgoing spam messages'));
